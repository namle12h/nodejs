...
export default function CheckoutPage() {
    ...
    // ⭐ Lấy token mới nhất từ Zustand store
    ...
    try {
        ...
        // ✅ Nếu là thanh toán online: tạo link VNPay
        await createPaymentUrl(orderId, finalOrderData.totalAmount);
        return { success: true, orderId };
        ...
        if (errorMsg?.startsWith("PENDING:")) {
            ...
            Modal.confirm({
                ...
                content: (
                    <>
                        <p>Đơn hàng này đã có hóa đơn ở trạng thái <b>PENDING</b>.</p>
