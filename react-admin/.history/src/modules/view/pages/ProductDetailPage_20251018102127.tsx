...
export default function ProductDetail() {
  ...
  const product = {
    ...
    reviews: 89,
    images: [
      "https://via.placeholder.com/400x400?text=Serum+1",
      "https://via.placeholder.com/400x400?text=Serum+2",
      "https://via.placeholder.com/400x400?text=Serum+3",
      "https://via.placeholder.com/400x400?text=Serum+4",
    ],
  };
