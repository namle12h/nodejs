...
import type Header from "../../../shared/components/Header";
import HeadServiceDetail from "./HeadServiceDetail";
      ...
      <Card className="shadow-md rounded-xl">
        ...
        <div className="flex justify-end mt-6 text-right">
          <div>
            ...
            <Link
              to="/products"
              className="inline-block mt-4 bg-pink-600 hover:bg-pink-700 text-white py-2 px-4 rounded-lg"
            >
              Tiếp tục mua sắm
            </Link>
            <Button
