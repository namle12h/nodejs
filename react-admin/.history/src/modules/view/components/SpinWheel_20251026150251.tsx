      ...
      <div className="flex flex-col items-center mb-8 md:mb-0 md:mr-12">
        ...
        <div className="relative flex items-center justify-center">
          <motion.div
            ...
            className="w-64 h-64 rounded-full border-[10px] border-white flex items-center justify-center bg-black text-white text-xl font-bold"
            style={{
              background: "conic-gradient(red 0deg 60deg, #111 60deg 120deg, red 120deg 180deg, #111 180deg 240deg, red 240deg 300deg, #111 300deg 360deg)",
            }}
          >
            🎁
          </motion.div>
