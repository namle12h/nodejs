...
const SpinWheel = () => {
    ...
    // ✅ Thứ tự hiển thị theo chiều kim đồng hồ, bắt đầu từ vị trí 12h
    const prizes = [
        "Voucher 50k",
        "Voucher 100k",
        "2% giảm giá",
    ...
    const handleSpin = () => {
        ...
        setTimeout(() => {
            ...
            const adjustedRotation = (normalizedRotation + 90 - segmentAngle / 2) % 360;
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-150px bg-gradient-to-br from-pink-400 to-red-400 p-6">
            {/* Vòng quay */}
            <div className="flex flex-col items-center mb-8 md:mb-0 md:mr-12">
                ...
                <div className="relative flex items-center justify-center">
                    <motion.div
                        ...
                        className="relative w-64 h-64 rounded-full  border-white flex items-center justify-center overflow-hidden"
                        style={{
                            background:
                    ...
                    >
                        ...
                        {["50k", "100k", "2%", "5%", "10%", "20%"].map((text, i) => (
                            <div
                                key={i}
                                className="absolute left-1/2 top-1/2 text-sm font-semibold text-white"
                                style={{
                                    transform: `rotate(${i * 60}deg) translate(85px) rotate(-${i * 60
                                        }deg)`,
                                }}
                            >
                                {text}
