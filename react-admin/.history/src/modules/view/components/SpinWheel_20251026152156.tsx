...
const SpinWheel = () => {
  ...
  // 🎯 Thứ tự phần thưởng theo chiều kim đồng hồ, bắt đầu từ vị trí 12h
  const prizes = [
    "Voucher 50k",
    "Voucher 100k",
    "2% giảm giá",
  ...
  const handleSpin = () => {
    ...
    // Quay ít nhất 4 vòng + góc ngẫu nhiên
    ...
    setTimeout(() => {
      ...
      // ⚙️ Cộng 90° để chuyển hướng 3h → 12h, trừ nửa ô để canh giữa kim
      const adjustedRotation =
        (normalizedRotation + 90 - segmentAngle / 2 + 360) % 360;
      ...
      <div className="flex flex-col items-center mb-8 md:mb-0 md:mr-12">
        ...
        <div className="relative flex items-center justify-center">
          <motion.div
            ...
            transition={{ duration: 3.5, ease: [0.17, 0.67, 0.83, 0.67] }}
