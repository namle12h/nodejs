...
export default function DashboardPage() {
  ...
  const stats = [
    { title: "Doanh Thu Hôm Nay", value:data?.revenue ? `${data.revenue.toLocaleString()}₫` : "0₫", iconBg: "bg-green-500", percent: "+12.5% so với hôm qua", icon: <DollarOutlined />, percentColor: "text-green-600", iconColor: "bg-green-500" },
