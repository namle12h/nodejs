...
const AppointmentManager = () => {
    ...
    const columns = [
        ...
        { title: "Thời gian kết thúc", dataIndex: "endAt", key: "endAt" , render: (val: string) => dayjs(val).format("HH:mm DD/MM/YYYY"),},
    ...
    const filteredData = appointments.filter((a: any) => {
        ...
        const inDateRange =
            !dateRange ||
            (dayjs(a.startAt).isAfter(dateRange[0], "day") &&
                dayjs(a.startAt).isBefore(dateRange[1], "day"));
