...
>
  <div className="space-y-3">
    ...
    >
      <Radio.Button
        value="cash"
        className="!flex !items-center !gap-2 !border !border-gray-200 !rounded-xl !py-2 !px-3 hover:!border-purple-400 transition"
      >
        💵 Tiền mặt
      </Radio.Button>
    ...
    <div className="mt-5">
      ...
      <Input
        ...
        type="number"
        prefix="₫"
        className="shadow-sm rounded-lg border-gray-200 focus:ring-2 focus:ring-purple-400"
      />
    </div>
  </div>
</Card>
