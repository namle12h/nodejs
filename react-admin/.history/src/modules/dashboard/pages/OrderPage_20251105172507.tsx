                    ...
                    >
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-100">
                                ...
                                <p className="font-semibold text-yellow-800"> {(orderData?.loyaltyPoints ?? 0).toLocaleString()} điểm</p>
                            </div>
                            <div className="bg-purple-50 p-3 rounded-lg border border-purple-100">
                                <p className="text-gray-500 text-sm">Hạng thành viên</p>
                                <p className="font-semibold text-purple-700">{orderData.rankLevel}</p>
                            </div>
                        </div>
