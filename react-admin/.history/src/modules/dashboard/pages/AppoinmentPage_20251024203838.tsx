            ...
            render: (_: any, record: any) => (
                <Space>
                    <Button type="link" icon={<EditOutlined />} onClick={() => handleEdit(record) }
                        disabled={record.status === "Completed" and record.status === "Canceled"
                        } />
                    ...
                    {record.status === "Cancelled" ? (
                        <Button disabled className="!bg-red-500 w-35" icon={<EditOutlined />} >
                            <span className="text-white ">Đã hủy</span>
                        </Button>
                    ) : (
                        <Button type="link" icon={<EditOutlined />} onClick={() => handleEdit(record)} />
                    )}
