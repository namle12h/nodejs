...
export default function DashboardPage() {
    ...
    const stats = [
        ...
        { title: "Lịch Hẹn Hoàn Thành", value: "3,892 lịch", iconBg: "bg-purple-500", percent: "+15.3%", icon: '📅' },
        { title: "Doanh Thu Ngày", value: "15,000,000 VND", iconBg: "bg-pink-500", percent: "+2.1%", icon: '🗓️' },
        { title: "Danh Thu Theo Dịch Vụ", value: "1,355,500,000 VND", iconBg: "bg-indigo-500", percent: "+5.7%", icon: '🛁' },
        { title: "Danh Thu Theo Sản Phẩm", value: "672,500,000 VND", iconBg: "bg-orange-500", percent: "-3.2%", percentColor: "text-red-500 bg-red-100", icon: '🧴' },
        { title: "Danh Thu Theo Tháng", value: "672,500,000 VND", iconBg: "bg-yellow-500", percent: "-3.2%", percentColor: "text-red-500 bg-red-100", icon: '📊' }, // Sửa màu percentColor thành text-red-500
