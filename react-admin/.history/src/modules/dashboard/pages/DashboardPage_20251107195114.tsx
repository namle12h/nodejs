...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { title: "Lịch Hẹn Hôm Nay", value: "24", iconBg: "bg-blue-500", percent: "+8.2% so với hôm qua", icon: <ScheduleOutlined className="w-6 h-6" />, percentColor: "text-green-600", iconColor: "bg-blue-500" },
