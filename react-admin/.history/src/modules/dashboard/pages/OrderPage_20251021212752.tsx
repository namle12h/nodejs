...
const OrderPage = ({ orderData }: { orderData: AppointmentRecord }) => {
    ...
    const [tempServices, setTempServices] = useState<ServiceInfo[]>([]);
    const [quantity, setQuantity] = useState(1);

    const { data: serviceData, isLoading } = useServices(1, 10);
    // 👉 Giá trị thanh toán
    ...
    // Demo data: bạn có thể load từ API thực tế
    const serviceList = [
        { id: 1, name: "Gội đầu dưỡng sinh", price: 120000 },
        { id: 2, name: "Massage toàn thân", price: 450000 },
        { id: 3, name: "Chăm sóc da mặt", price: 280000 },
    ];
    ...
    const handleAddService = () => {
        ...
        setTempServices((prev: any) => [...prev, service]);
    ...
    const handleAddProduct = async () => {
        ...
        try {
            await axios.patch(`/api/appointments/${orderData.id}/add-product`, {
