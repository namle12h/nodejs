...
export default function DashboardPage() {
    ...
    const stats = [
        { title: "Doanh Thu Hôm Nay", value: "12,450,000₫", iconBg: "bg-green-500", percent: "+12.5% so với hôm qua", icon: '💲', percentColor: "text-green-600", iconColor: "bg-green-500" },
        { title: "Lịch Hẹn Hôm Nay", value: "24", iconBg: "bg-blue-500", percent: "+8.2% so với hôm qua", icon: '📅', percentColor: "text-green-600", iconColor: "bg-blue-500" },
        { title: "Khách Hàng Mới", value: "8", iconBg: "bg-purple-500", percent: "+15.3% so với hôm qua", icon: '🧑‍🤝‍🧑', percentColor: "text-green-600", iconColor: "bg-purple-500" },
        { title: "Tỷ Lệ Hoàn Thành", value: "94.2%", iconBg: "bg-teal-500", percent: "-2.1% so với hôm qua", percentColor: "text-red-500", icon: '✔️', iconColor: "bg-teal-500" },
    ];
