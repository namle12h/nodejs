...
import { Table, Button, Input, DatePicker, Select, Tag, Pagination, Space, Card, message, Modal } from "antd";
import {
    SearchOutlined,
    PlusOutlined,
    FileExcelOutlined,
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            >
                {/* ✅ Gọi đúng cách */}
                {/* <OrderPage /> */}
                {selectedPaymentRecord && <OrderPage orderData={selectedPaymentRecord} />}
            </Modal>
