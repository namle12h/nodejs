...
interface SelectWrapperProps { 
    ...
    isOpen: boolean; 
    onToggle: () => void;
    // Thêm props để nhận giá trị và hàm thay đổi giá trị
    value: string | string[]; 
    onChange: (newValue: string | string[]) => void;
}

// ---------------------------------------------------
// CUSTOM DROPDOWN COMPONENT (Cập nhật để dùng props value/onChange)
// ---------------------------------------------------
...
export default function AdvancedFilters() {
    ...
    // Trạng thái cho các giá trị lọc (để reset)
    ...
    const handleReset = () => {
        ...
        setOpenDropdown(null); // Đóng mọi dropdown nếu đang mở
        // Logic để bỏ chọn các bộ lọc nhanh nếu cần
    };
    ...
    return (
        <div className="mt-4 p-5 border border-gray-200 rounded-xl bg-gray-50 transition-all duration-300 ease-in-out">
            ...
            <div className="flex justify-between items-center mb-5">
                ...
                <button 
                    ...
                    className="text-pink-600 text-sm hover:underline flex items-center space-x-1"
                >
                    <X className="w-4 h-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                {/* Loại khách hàng (Dropdown Single-select) */}
                <SelectWrapper 
                ...
                {/* Chi nhánh (Dropdown Single-select) */}
                <SelectWrapper 
                    label="Chi nhánh" 
                    placeholder="Tất cả chi nhánh" 
                    data={branchData} type="branch" isMultiSelect={false} // Chuyển thành Single-select cho Chi nhánh
