...
export default function RevenueAnalysis() {
    ...
    const [dataCategory, setDataCategory] = useState<'revenue' | 'customer' | 'appointment' | 'satisfaction'>('customer');
            ...
            <div className="lg:col-span-2">
                ...
                <div className="flex justify-end items-center mb-4 space-x-2">
                    <select
                        ...
                        value={dataCategory}
                        onChange={(e) => setDataCategory(e.target.value as 'revenue' | 'customer' | 'appointment' | 'satisfaction')}
                    >
