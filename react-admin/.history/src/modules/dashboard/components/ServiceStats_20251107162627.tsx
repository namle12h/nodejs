...
              innerRadius={45}
              outerRadius={70}
              stroke="none" // Đặt lại "none"
              strokeWidth={0} // Đặt lại 0
              paddingAngle={0} // BỎ paddingAngle để loại bỏ khoảng trắng
            >
              {data.map((entry, i) => (
                <Cell 
                  key={i} 
                  fill={entry.color} 
                  stroke="none" // Rất quan trọng: Phải là "none"
                  strokeWidth={0} // Rất quan trọng: Phải là 0
                />
              ))}
            </Pie>
          </PieChart>
