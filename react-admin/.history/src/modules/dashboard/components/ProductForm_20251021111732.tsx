...
export default function ProductForm({
  ...
  return (
    ...
    >
      ...
      > */}
      <Form
  key={initialValues?.id || "new"} // 👈 giúp re-render khi đổi sản phẩm
  form={form}
  layout="vertical"
  onFinish={handleFinish}
  initialValues={{
    ...
    ...initialValues,
    expDate:
      initialValues?.expDate && dayjs(initialValues.expDate).isValid()
        ? dayjs(initialValues.expDate)
        : null,
    file: initialValues?.imageUrl
      ? [
          {
            uid: "-1",
            name: "current-image.jpg",
