...
export default function CustomerAnalysis() {
    ...
    const ageData = [
        ...
        { 
            label: "51+", 
            value: ageGroups["51+"], 
            percent: `${(ageGroups["51+"] / Object.values(ageGroups).reduce((a, b) => a + b, 0)) * 100}%`, 
            color: "#f97316" 
        }
    ];
    ...
    const customerData = [
        { 
            ...
            percent: `${(data.newCustomers / (data.newCustomers + data.returningCustomers + data.vipCustomers)) * 100}%`, 
            color: "#ec4899", 
            Icon: () => '♀️' 
        },
        { 
            ...
            percent: `${(data.returningCustomers / (data.newCustomers + data.returningCustomers + data.vipCustomers)) * 100}%`, 
            color: "#a855f7", 
            Icon: () => '🔁' 
        },
        { 
            ...
            percent: `${(data.vipCustomers / (data.newCustomers + data.returningCustomers + data.vipCustomers)) * 100}%`, 
            color: "#f43f5e", 
            Icon: () => '👑' 
        },
    ];
