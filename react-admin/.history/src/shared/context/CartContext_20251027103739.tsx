...
import { useCart } from "../../../shared/context/CartContext"; // ✅ Import context
import { useState } from "react";

export default function CartPage() {
  const navigate = useNavigate();
  const { cart, removeFromCart, updateQuantity } = useCart(); // ✅ dùng context
  ...
  const handleRemove = (id: number) => {
    removeFromCart(id); // ✅ cập nhật context → Header tự cập nhật
  };
